...
from extract_wait_times_webarchive import handle_webarchive_download, setup_chrome_driver # webarchive functionality
...
def process_url(dataurl, raw_data_dir):
    ...
    try:
        ...
        for link in soup.find_all('a', href=True):
            ...
            if file_type in ["pdf", "xls", "xlsx", "csv"] and "provider" in link_text:
...
def main():
    ...
    try:
        ...
        BASE_DIR = Path.cwd()
    RAW_DATA_DIR = os.getenv("RAW_DATA_DIR", BASE_DIR / "rawdata" / "wait-times")
    os.makedirs(RAW_DATA_DIR, exist_ok=True)
    # Defining URL with data
    urls = [
        "https://www.england.nhs.uk/statistics/statistical-work-areas/rtt-waiting-times/rtt-data-2011-12/",
        "https://www.england.nhs.uk/statistics/statistical-work-areas/rtt-waiting-times/rtt-data-2012-13/",
        "https://www.england.nhs.uk/statistics/statistical-work-areas/rtt-waiting-times/rtt-data-2013-14/",
        "https://www.england.nhs.uk/statistics/statistical-work-areas/rtt-waiting-times/rtt-data-2014-15/",
        "https://www.england.nhs.uk/statistics/statistical-work-areas/rtt-waiting-times/rtt-data-2015-16/",
        "https://www.england.nhs.uk/statistics/statistical-work-areas/rtt-waiting-times/rtt-data-2016-17/",
