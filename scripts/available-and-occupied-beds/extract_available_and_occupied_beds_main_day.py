...
def main():
    ...
    try:
        ...
        BASE_DIR = "Path.cwd()"
    RAW_DATA_DIR = os.getenv("RAW_DATA_DIR", BASE_DIR / "rawdata" / "available-and-occupied-beds" / "day")
    os.makedirs(RAW_DATA_DIR, exist_ok=True)
    # Defining URL with data
    dataurl = "https://www.england.nhs.uk/statistics/statistical-work-areas/bed-availability-and-occupancy/bed-data-day-only/"
